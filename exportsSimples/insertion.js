//tudo ok!!!
function insertion(vet,fim) {//recebe o array , inicio e o fim
    for(var i = 1;i<fim;i++){//Varre o vetor da segunda posição em diante;
...
module.exports={
   ordernar(z){
      return insertion(z,z.length)
   }
}

/*
const ordenar2 = require('./insertion')//requisiscao da pasta
var y = ordenar2.ordernar(media.x)//chama a requisicao e a funcao de ordernar que recebe um array e o ordena
console.log(y)
*/ 